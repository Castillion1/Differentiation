public class Differentiation {
    ...
    public static String differentiation(String toDifferentiate, String checkingFor) { //Differentiate's the given term
        ...
        return (returning + checkingFor + "^" + power);// return answer
    } //
    ...
    // public static String FindCharNumberOne(String toSearch, String charToSearch){ // WIP
    //      char checkingForChar =checkingFor.charAt(0);
    //      if (!(toSearch.contains(checkingForChar))){
    //           return ("0");
    //      }else{
    //
    //      }
    // }
    public static String MakeQuestion(int plusMinusFirst, int coeffcientOfHighX, int powerOfHighX, int plusMinusSecond, int coeffcientOfMiddleX, int powerOfMiddleX, int plusMinusThird, int constant) {
        String outputMessage = "";
        if (plusMinusFirst == 1) {
            outputMessage += "-";
        }
        System.out.println(outputMessage);
        if (coeffcientOfHighX > 0) {
            outputMessage += Integer.toString(coeffcientOfHighX);
        }
        outputMessage += "X^";
        outputMessage += Integer.toString(powerOfHighX);
        System.out.println(outputMessage);
        if (plusMinusSecond == 1) {
            outputMessage += "-";
        } else {
            outputMessage += "+";
        }
        System.out.println(outputMessage);
        if (coeffcientOfMiddleX > 0) {
            outputMessage += Integer.toString(coeffcientOfMiddleX);
        }
        outputMessage += "X";
        System.out.println(outputMessage);
        if (powerOfMiddleX > 0) {
            outputMessage += "^";
            System.out.println(powerOfMiddleX);
            outputMessage += Integer.toString(powerOfMiddleX);
        }
        if (plusMinusThird == 1) {
            outputMessage += "-";
        } else {
        ...
        System.out.println(outputMessage);
        if (constant > 0) {
            outputMessage += Integer.toString(constant);
        }
        return (outputMessage);
    }

    public static String MakeQuestionStarter(int plusMinusFirst, int coeffcientOfHighX, int powerOfHighX, int plusMinusSecond, int coeffcientOfMiddleX, int powerOfMiddleX, int plusMinusThird, int constant) {
        String Answer = MultiplyingBracketsStarter(MakeQuestion(plusMinusFirst, coeffcientOfHighX, powerOfHighX, plusMinusSecond, coeffcientOfMiddleX, powerOfMiddleX, plusMinusThird, constant));
        return (Answer);
    }

    public static String MakeQuestionStarter(int plusMinusFirst, int coeffcientOfHighX, int powerOfHighX, int plusMinusSecond, int coeffcientOfMiddleX, int powerOfMiddleX, int plusMinusThird, int constant, int SecondplusMinusFirst, int SecondcoeffcientOfHighX, int SecondpowerOfHighX, int SecondplusMinusSecond, int SecondcoeffcientOfMiddleX, int SecondpowerOfMiddleX, int SecondplusMinusThird, int Secondconstant) {
        String answerLeft = MakeQuestion(plusMinusFirst, coeffcientOfHighX, powerOfHighX, plusMinusSecond, coeffcientOfMiddleX, powerOfMiddleX, plusMinusThird, constant);
        String answerRight = MakeQuestion(SecondplusMinusFirst, SecondcoeffcientOfHighX, SecondpowerOfHighX, SecondplusMinusSecond, SecondcoeffcientOfMiddleX, SecondpowerOfMiddleX, SecondplusMinusThird, Secondconstant);
        String answerFinal = MultiplyingBracketsStarter(answerLeft, answerRight);
        return (answerFinal);
    }

    public static void main(String[] args) {
        // System.out.println(MultiplyingBracketsStarter("-8X^9+10X^2+7"));

        System.out.println(MakeQuestionStarter(0, 7, 6, 0, 3, 4, 1, 2));
        System.out.println(MakeQuestionStarter(0, 7, 6, 0, 3, 4, 1, 2, 0, 5, 6, 0, 3, 4, 1, 9));
        System.out.println(MultiplyingBracketsStarter("7X^6+3X^4-2"));
        //System.out.println(MultiplyingBracketsStarter("-6X^6+5X^2+9"));
    }
}
